         ...
         if($url =~ /^\/rest\?(.*)/) {
            ...
            if($self->{catalog}) {                       # -- dealing with a catalog, determine which entry
               if($url =~ s/\/([\w\.\-]+)\//\//) {
                  ...
                  $body = "<html><head><title>Catalog</title><link href=\"data:image/x-png;base64,\" rel=\"shortcut icon\" type=\"image/x-png\">
